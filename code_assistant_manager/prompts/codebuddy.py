...
class CodebuddyPromptHandler(BasePromptHandler):
    ...
    def get_live_content(
        ...
        # If CODEBUDDY.md missing but AGENTS.md exists, prefer AGENTS.md content
        if level == "project":
            base = Path(project_dir or Path.cwd())
        else:
        ...
        # Otherwise assemble context from README.md, CLAUDE.md, .cursor* and copilot-instructions
        parts = []
    ...
    def import_from_live(
        ...
        # fallback to assembling context
